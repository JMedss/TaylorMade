...
const Locations = () => {
  return (
    <section className='bg-white dark:bg-darkprimary w-full min-h-[90vh] mt-[120px] min-w-[300px] z-10'>
      <div className='container min-w-[300px] flex flex-col gap-6 items-center'>
        <h1 className='my-[60px]'>Taylor-Made Locations</h1>
        <LocationCard name="Taylor-Made Barber Shop" address="817 West Walnut St. Suite #7 Johnson City, TN 37604" img="/lightlogo.png" size={400} alt="Taylor-Made Barber Shop Logo" href="/johnsoncitybarbershop" minwidth="min-w-[200px]" /> 
