        ...
        <div className='container flex flex-col justify-center items-center min-w-[300px] relative'>
          <div className='absolute bottom-[125px] md:right-0 md:top-[50%] xl:translate-x-[-50%] z-0'>
            ...
            <div className='flex flex-col items-center md:items-start my-[120px] z-20 w-full'>
                <FeatureCard header="Get the haircut you paid for." bfText="We have all been there. Disappointed after getting a new haircut. Our barbers are" redText="true masters" afText="of their craft. This will be the last time you have to search best barber shop near me!" />
                <FeatureCard header="A barber for any hair type." bfText="We have multiple barbers that specialize in many hairstyles and types. Make sure you check out our different barbers to" redText="find the right barber" afText="for you." />
                <FeatureCard header="No more aimlessly waiting." bfText="Track the waiting time with our new tracking system. When your appointment is near," redText="go to our tracker." afText="This will be the last time you have to search best barber shop near me!" />
            </div>
            <button
