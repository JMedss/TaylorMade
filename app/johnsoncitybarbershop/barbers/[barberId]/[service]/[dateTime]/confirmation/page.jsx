  ...
  return (
    <main className='mt-[120px] w-screen h-screen'>
        <div className='container flex flex-col'>
            ...
            <p>Don't forget to check your spam if you have not recieved an email! Thank you for booking with Taylor-Made.</p>
        </div>
    </main>
  )
}

export default JCConfirmation
